...
namespace Log4Qt
{
	...
	LOG4QT_DECLARE_STATIC_LOGGER(logger, Log4Qt::Properties)
		...
		void Properties::load(QFile* pDevice)
	{
		...
		do {
            ...
            if (line.contains(".File="))
            {
                ...
                QString dataPath = documentPath + "/" + QApplication::applicationDisplayName() + "/";

                line.replace(".File=", ".File=" + dataPath);
                OutputDebugStringA(line.toLocal8Bit());
            }
			line_number++;
